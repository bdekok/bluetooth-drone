...
export class ParrotDrone {
  ...
  _setAdvancedSpeed(inputProperties) {    
  ...
  moveForwards() {
    this._setSpeed('pitch', DEFAULT_SPEED);
  };
  ...
  moveLeft() {
    this._setSpeed('yaw', -DEFAULT_SPEED);
  };

  moveLeftForwards() {
    this._setAdvancedSpeed({pitch: DEFAULT_SPEED, roll: -DEFAULT_SPEED});
  }
  moveRightForwards() {
    this._setAdvancedSpeed({pitch: DEFAULT_SPEED, roll: DEFAULT_SPEED});
  }
  ...
  moveUp() {
    this._setSpeed('altitude', DEFAULT_SPEED);
  };
